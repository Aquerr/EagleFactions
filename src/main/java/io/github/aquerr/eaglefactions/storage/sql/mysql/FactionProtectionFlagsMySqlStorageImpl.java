...
public class FactionProtectionFlagsMySqlStorageImpl implements FactionProtectionFlagsStorage
{
    ...
    public FactionProtectionFlagsMySqlStorageImpl(SQLProvider sqlProvider)
    {
