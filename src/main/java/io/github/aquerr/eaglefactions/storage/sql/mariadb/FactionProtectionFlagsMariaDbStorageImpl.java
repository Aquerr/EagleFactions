...
public class FactionProtectionFlagsMariaDbStorageImpl implements FactionProtectionFlagsStorage
{
    ...
    public FactionProtectionFlagsMariaDbStorageImpl(SQLProvider sqlProvider)
    {
        this.sqlProvider = sqlProvider;
    }

    @Override
    public Set<ProtectionFlag> getProtectionFlags(String factionName) throws SQLException
    {
        PreparedStatement preparedStatement = sqlProvider.getConnection().prepareStatement(SELECT_PROTECTION_FLAGS_FOR_FACTION);
    ...
    @Override
    public void saveProtectionFlags(String factionName, Set<ProtectionFlag> newProtectionFlags) throws SQLException
    {
        Set<ProtectionFlag> existingProtectionFlags = getProtectionFlags(factionName);
        ...
        // Delete
        deleteProtectionFlags(factionName, flagsToDelete);
        // Update
        updateProtectionFlags(factionName, flagsToUpdate);
        // Insert
        insertProtectionFlags(factionName, flagsToInsert);
    }

    @Override
    public void deleteProtectionFlags(String factionName) throws SQLException
    {
        PreparedStatement preparedStatement = this.sqlProvider.getConnection().prepareStatement(DELETE_ALL_PROTECTION_FLAGS_FOR_FACTION);
        preparedStatement.setString(1, factionName);
        preparedStatement.executeUpdate();
        preparedStatement.close();
    }

    private void deleteProtectionFlags(String factionName, Set<ProtectionFlag> protectionFlags) throws SQLException
    {
        PreparedStatement preparedStatement = this.sqlProvider.getConnection().prepareStatement(DELETE_PROTECTION_FLAGS_FOR_FACTION_AND_PROTECTION_FLAG);
    ...
    private void updateProtectionFlags(String factionName, Set<ProtectionFlag> protectionFlags) throws SQLException
    {
        PreparedStatement preparedStatement = this.sqlProvider.getConnection().prepareStatement(UPDATE_PROTECTION_FLAGS_FOR_FACTION);
        for (ProtectionFlag protectionFlag : protectionFlags)
        {
            preparedStatement.setString(1, factionName);
            preparedStatement.setString(2, protectionFlag.getType().getName());
    ...
    private void insertProtectionFlags(String factionName, Set<ProtectionFlag> protectionFlags) throws SQLException
    {
        PreparedStatement preparedStatement = this.sqlProvider.getConnection().prepareStatement(INSERT_PROTECTION_FLAGS_FOR_FACTION);
        for (ProtectionFlag protectionFlag : protectionFlags)
        {
            preparedStatement.setString(1, factionName);
            preparedStatement.setString(2, protectionFlag.getType().getName());
