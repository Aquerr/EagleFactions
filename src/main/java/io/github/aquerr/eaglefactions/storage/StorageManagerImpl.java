...
//        Sponge.server().sendMessage(PluginInfo.PLUGIN_PREFIX.append(Component.text("Filling cache with data...", NamedTextColor.AQUA)));
//        reloadFactionCache();
//        reloadPlayerCache(); //Consider using cache that removes objects which have not been used for a long time.
    }
    ...
    private void reloadFactionCache()
    {
    ...
    private void reloadPlayerCache()
    {
