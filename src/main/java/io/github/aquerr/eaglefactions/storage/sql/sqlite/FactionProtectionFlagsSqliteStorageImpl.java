...
public class FactionProtectionFlagsSqliteStorageImpl implements FactionProtectionFlagsStorage
{
    ...
    public FactionProtectionFlagsSqliteStorageImpl(SQLProvider sqlProvider)
    {
