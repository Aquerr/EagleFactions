...
//                createFileIfNotExists(factionFilePath, false);
                final HoconConfigurationLoader configurationLoader = HoconConfigurationLoader.builder().defaultOptions(ConfigurateHelper.getDefaultOptions()).path(factionFilePath).build();
...
//                createFileIfNotExists(playerFile, false);
                final HoconConfigurationLoader playerConfigLoader = HoconConfigurationLoader.builder().path(playerFile).build();
...
//        createFileIfNotExists(factionsDirPath, true);
        ...
        if (factionsFiles != null)
        {
            ...
            {
                final HoconConfigurationLoader hoconConfigurationLoader = HoconConfigurationLoader.builder().defaultOptions(ConfigurateHelper.getDefaultOptions()).file(file).build();
