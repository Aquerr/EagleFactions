...
public class MySQLProvider extends SQLAbstractProvider implements SQLProvider
{
    ...
    private MySQLProvider(final EagleFactions eagleFactions) throws SQLException
    {
        ...
        final SqlManager sqlService = Sponge.sqlManager();
        this.dataSource = sqlService.dataSource("jdbc:mysql://" + super.getUsername() + ":" + super.getPassword() + "@" + super.getDatabaseUrl() + "?useUnicode=true&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        ...
        this.dataSource = sqlService.dataSource("jdbc:mysql://" + super.getUsername() + ":" + super.getPassword() + "@" + super.getDatabaseUrl() + super.getDatabaseName() + "?useUnicode=true&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
    }
