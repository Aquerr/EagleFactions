...
public class FactionPowerParser implements EFPlaceholderParser
{
    private final FactionLogic factionLogic;
    private final PowerManager powerManager;

    FactionPowerParser(FactionLogic factionLogic, PowerManager powerManager)
    {
    ...
    private Optional<String> parseByServerPlayer(ServerPlayer serverPlayer)
    {
        return Optional.of(serverPlayer)
                ...
                .map(powerManager::getFactionPower)
                .map(String::valueOf);
    }
}
