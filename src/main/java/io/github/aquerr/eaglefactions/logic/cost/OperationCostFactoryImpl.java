...
public class OperationCostFactoryImpl implements OperationCostFactory
{
    ...
    public OperationCostFactoryImpl(PowerManager powerManager)
    {
    ...
    {
        return new OperationPowerCostImpl(this.powerManager, power);
    }

    @Override
    public OperationHavingPowerCost havingPower(float power)
    {
        return new OperationHavingPowerCostImpl(this.powerManager, power);
    }

    @Override
    public OperationItemsCost items(List<ItemStack> items)
    {
        return new OperationItemsCostImpl(items);
    }
}
