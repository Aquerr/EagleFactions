...
public final class PluginInfo
{
    ...
    public static final TextComponent PLUGIN_PREFIX = Component.text("[EF] ", NamedTextColor.AQUA);
    public static final TextComponent ERROR_PREFIX = Component.text("[EF] ", NamedTextColor.DARK_RED);
