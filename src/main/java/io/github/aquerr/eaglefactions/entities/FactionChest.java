...
public class FactionChest implements Serializable
{
    ...
    public ItemStack getAtPosition(int row, int column)
    {
        ...
        for(SlotItem slotItem : this.items)
        {
            if(slotItem.getRow() == row && slotItem.getColumn() == column)
                itemStack = ItemStack.of(slotItem.getItem().getItem(), slotItem.getItem().getQuantity());
        }
    ...
    public Inventory toInventory()
    {
        ...
        Inventory inventory = Inventory.builder()
                ...
                .property(InventoryTitle.PROPERTY_NAME, InventoryTitle.of(Text.of(TextColors.BLUE, Text.of("Faction's chest"))))
