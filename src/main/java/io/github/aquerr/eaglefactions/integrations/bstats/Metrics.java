...
//    {
//        Preconditions.checkNotNull(chart, "Chart cannot be null");
//        charts.add(chart);
//    }
//
//    /**
...
//
//        String pluginName = plugin.metadata().name().get();
//        String pluginVersion = plugin.metadata().version();
//
...
//                scheduler.submit(Task.builder().execute(() -> submitData()).build());
//            }
//        };
...
//        int playerAmount = Sponge.server().onlinePlayers().size();
...
//        String spongeImplementation = Sponge.platform().container(Platform.Component.IMPLEMENTATION).metadata().name().get();
//
...
//
//        if (!Sponge.metricsConfigManager().collectionState(this.plugin).asBoolean())
//            return;
//
