...
public class DynmapUtils {
    ...
    public static int getAreaColor(final Faction faction) {
        ...
        {
            areaColor = faction.getTag().color().value();
        }
        else
        {
