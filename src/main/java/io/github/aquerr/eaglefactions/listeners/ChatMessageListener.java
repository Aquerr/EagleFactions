...
public class ChatMessageListener extends AbstractListener
{
    ...
    public void onChatMessage(final PlayerChatEvent event, final @Root Player plaer)
    {
        System.out.println(event);
    }

    @Listener
    public void onMessageChannel(final MessageEvent event, final @Root Audience player)
    {
        System.out.println(event);
    }
...
//    @Listener
//    @IsCancelled(Tristate.FALSE)
//    public void onChatMessage(final MessageChannelEvent event, final @Root Player player)
//    {
