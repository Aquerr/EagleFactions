...
public class FactionTagUpdateListener extends AbstractListener
{
    public FactionTagUpdateListener(EagleFactions plugin)
    {
        super(plugin);
    }
    ...
    public void onTagUpdate(final FactionTagUpdateEvent.Post event)
    {
