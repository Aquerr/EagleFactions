...
public final class EventRunner
{
     ...
     * @return True if cancelled, false if not
     */
	public static boolean runFactionAreaEnterEventPre(final MoveEntityEvent moveEntityEvent, final Player player, final Faction enteredFaction, final Faction leftFaction)
	{
	    final EventContext eventContext = getEventContextForPlayer(player).build();
     ...
     * @return True if cancelled, false if not
     */
    public static boolean runFactionAreaEnterEventPost(final MoveEntityEvent moveEntityEvent, final Player player, final Faction enteredFaction, final Faction leftFaction)
    {
        final EventContext eventContext = getEventContextForPlayer(player).build();
        final Cause eventCause = Cause.of(eventContext, player, enteredFaction, leftFaction);
    ...
    {
        return EventContext.builder().add(EventContextKeys.PLAYER, player);
    }
}
