...
public class FactionAreaEnterEventImpl extends AbstractEvent implements FactionAreaEnterEvent
{
	...
	private final Faction enteredFaction;
	private final Faction leftFaction;

	private boolean isCancelled = false;

	FactionAreaEnterEventImpl(final MoveEntityEvent moveEntityEvent, final Player creator, final Faction enteredFaction, final Faction leftFaction, final Cause cause)
	{
	...
	{
		return Optional.ofNullable(this.enteredFaction);
	}

	@Override
	public Optional<Faction> getLeftFaction()
	{
		return Optional.ofNullable(this.leftFaction);
	}
	...
	{
		Pre(MoveEntityEvent moveEntityEvent, Player creator, Faction enteredFaction, Faction leftFaction, Cause cause)
		{
	...
	{
		Post(MoveEntityEvent moveEntityEvent, Player creator, Faction enteredFaction, Faction leftFaction, Cause cause)
		{
			super(moveEntityEvent, creator, enteredFaction, leftFaction, cause);
		}
	}
