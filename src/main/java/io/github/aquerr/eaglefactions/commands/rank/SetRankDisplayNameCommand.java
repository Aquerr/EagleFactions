...
public class SetRankDisplayNameCommand extends AbstractCommand
{
    private final PermsManager permsManager;
    private final PlayerManager playerManager;
    private final MessageService messageService;
    private final RankManager rankManager;
    public SetRankDisplayNameCommand(EagleFactions plugin)
    {
        super(plugin);
    ...
    public CommandResult execute(CommandContext context) throws CommandException
    {
        ...
        Component formattedText = context.requireOne(Parameter.formattingCodeText().key("display_name").build());

        String displayName = LegacyComponentSerializer.legacyAmpersand().serialize(formattedText);
        ...
        try
        {
            this.rankManager.setRankDisplayName(faction, rank, displayName);
