...
public class SetRankPermissionCommand extends AbstractCommand
{
    ...
    public SetRankPermissionCommand(EagleFactions plugin)
    {
        super(plugin);
    ...
    public CommandResult execute(CommandContext context) throws CommandException
    {
        ...
        try
        {
            this.rankManager.setRankPermission(faction, rank, permission);
