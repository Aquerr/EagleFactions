...
import io.github.aquerr.eaglefactions.commands.management.WorldCommand;
...
//
//id = PluginInfo.ID, name = PluginInfo.NAME, version = PluginInfo.VERSION, description = PluginInfo.DESCRIPTION, authors = PluginInfo.AUTHOR,
...
//    private Metrics metrics;
    ...
    @Inject
    public EagleFactionsPlugin(PluginContainer pluginContainer, Logger logger)
    {
    ...
    public void onServerInitialization(final ConstructPluginEvent event)
    {
        ...
        this.logger.info("Preparing wings...");

        setupConfigs();

        this.logger.info("Configs loaded.");

        this.logger.info("Loading managers and cache...");
        setupManagers();
        registerAPI();

        this.logger.info("Managers loaded.");
        ...
        this.logger.info("==========================================");
        this.logger.info("Eagle Factions is ready to use!");
        this.logger.info("Thank you for choosing this plugin!");
        this.logger.info("You are currently using version: " + PluginInfo.VERSION);
        this.logger.info("We wish you a great time while playing factions! :D");
        this.logger.info("==========================================");
        ...
        CompletableFuture.runAsync(() ->
        {
            ...
            {
                this.logger.info("Hey! A new version of " + PluginInfo.NAME + " is available online!");
                this.logger.info("==========================================");
            }
        });
    }
    ...
    public void onGameStarting(final StartingEngineEvent<Server> event)
    {
        try
        {
            ...
            Optional placeholderService1 = Sponge.serviceProvider().provide(placeholderInterface);
...
//                efPlaceholderService = EFPlaceholderService.getInstance(this, placeholderService);
    ...
    public void onReload(final RefreshGameEvent event)
    {
        ...
        if(event.source() instanceof Player)
        {
            ...
            player.sendMessage(PluginInfo.PLUGIN_PREFIX.append(Component.text(Messages.CONFIG_HAS_BEEN_RELOADED)));
        }
    }
    ...
    {
        configuration = new ConfigurationImpl(configDir, configAsset, worldsAsset);
        MessageLoader.init(this, this.pluginContainer);
    ...
    private void setupManagers()
    {
        ...
        this.playerManager = new PlayerManagerImpl(() -> Sponge.server().userManager(), this.storageManager, this.factionLogic, this.getConfiguration().getFactionsConfig(), this.configuration.getPowerConfig());
...
//        Sponge.serviceProvider().registration(FactionLogic.class).get(), this.factionLogic);
//        Sponge.serviceProvider().registration(this, PowerManager.class, this.powerManager);
//        Sponge.serviceProvider().registration(this, PlayerManager.class, this.playerManager);
//        Sponge.serviceProvider().registration(this, ProtectionManager.class, this.protectionManager);
//        Sponge.serviceProvider().registration(this, PermsManager.class, this.permsManager);
//        Sponge.serviceProvider().registration(this, PVPLogger.class, this.pvpLogger);
//        Sponge.serviceProvider().registration(this, AttackLogic.class, this.attackLogic);
//        Sponge.serviceProvider().registration(this, InvitationManager.class, this.invitationManager);
//        Sponge.serviceProvider().registration(this, RankManager.class, this.rankManager);
    }
    ...
    private void initializeCommands(RegisterCommandEvent<Command.Parameterized> event)
    {
        ...
        SUBCOMMANDS.put(Collections.singletonList("world"), Command.builder()
                .shortDescription(Component.text("World Test"))
                .permission(PluginPermissions.ACCESS_COMMAND)
