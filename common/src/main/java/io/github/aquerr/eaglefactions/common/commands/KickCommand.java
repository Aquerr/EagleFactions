...
public class KickCommand extends AbstractCommand
{
    ...
    public CommandResult execute(final CommandSource source, final CommandContext context) throws CommandException
    {
        ...
        if(!isCancelled)
        {
            ...
            source.sendMessage(Text.of(PluginInfo.PLUGIN_PREFIX, TextColors.GREEN, MessageLoader.parseMessage(Messages.YOU_KICKED_PLAYER_FROM_THE_FACTION, Collections.singletonMap(Placeholders.FACTION_NAME, Text.of(TextColors.GOLD, selectedPlayer.getName())))));
